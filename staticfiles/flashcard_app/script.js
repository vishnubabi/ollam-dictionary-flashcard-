// Modern Flashcard App with Enhanced Features
class FlashcardApp {
    constructor() {
    ...
    startReviewTimer() {
        // Optional: Track time spent reviewing
        this.reviewStartTime = new Date();
    }
    
    setupKeyboardShortcuts() {
        document.addEventListener('keydown', (e) => {
            // Prevent shortcuts if typing or modal is open
    ...
    showSettings() {
        ...
        this.showToast('⚙️ Settings coming soon! Stay tuned for customization options.', 'info', 3000);
    }
